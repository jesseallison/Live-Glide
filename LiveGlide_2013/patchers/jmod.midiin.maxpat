...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"annotation" : "Choose whether data should be normalized to a [0. 1.] range.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-27",
					"maxclass" : "textbutton",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 57.0, 80.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 98.0, 137.0, 17.0 ],
...
, 			{
				"box" : 				{
					"annotation" : "Choose which MIDI device to use",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"hint" : "Device",
					"id" : "obj-12",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 140.0, 304.0, 103.0, 19.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Applications/Max 6.1/packages/Jamoma-0.5.7/patchers/modules/control/midiin",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
